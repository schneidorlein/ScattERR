...
from interface_dropdown import Ui_MainWindow
...
class MainWindow(QMain, Ui_MainWindow):
    ...
    def parkposition_s1(self):
        ...
        if position == 'PARK':
            ...
            logging.info('\'Park\' option for 1st scatterer chosen. Scatterer is now moving to parking position.')
    ...
    def beamposition_s1(self):
        ...
        if position == 'BEAM':
            ...
            logging.info('\'Beam\' option for 1st scatterer chosen. Scatterer is now moving to beam position.')
    ...
    def parkposition_s2(self):
        ...
        if position == 'PARK':
            ...
            logging.info('\'Park\' option for 2nd scatterer chosen. Scatterer is now moving to parking position.')
    ...
    def beamposition_s2(self):
        ...
        if position == 'BEAM':
            ...
            logging.info('\'Beam\' option for 2nd scatterer chosen. Scatterer is now moving to beam position.')
